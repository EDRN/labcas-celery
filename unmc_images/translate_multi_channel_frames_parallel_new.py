...
def register_folder(fixed_dapi, dapi_file, mx, my, in_folder, out_folder):
    ...
    # subsample frame if needed
    xx,yy = [x // 20000 for x in im1.shape]
    im1 = im1[0::xx,0::yy]
    im2 = im2[0::xx,0::yy]
    ...
    shift, error, diffphase = register_translation(im1, im2, upsample_factor=max(xx,yy))
...
def main(input_path, output_path, parallel=0):
    ...
    #input_path = '/Users/altinok/Desktop/Liver2/'
    # root folder where the output to be written
    #output_path = '/Users/altinok/Desktop/Liver2_registered_parallel/'
